...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.12.11@sha256:91307cefa54bc6f8484358f486b23e35ec066433a7e5214bf479ec735fb218e3
