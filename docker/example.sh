...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:3.0.0@sha256:bcda1b651778b9a0e2dc87fb9933e36cd116d472aa7f20b1e7e501e6a2a52d0b
