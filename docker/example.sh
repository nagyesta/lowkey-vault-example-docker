...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:3.0.6@sha256:2cf69f2ff407de5775b73b74284fe572b294fdbf26b218b4f2a39ce0d5812f5b
