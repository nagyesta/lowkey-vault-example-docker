...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.5.81@sha256:3de3f1baf2c2d5b30c40ddbfa8e4f3e884f60fba5f2dc98556ec3eb21b72e41d
