...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.2.5@sha256:a1813c8679695fdbce8042cff1241467e9385a2515af931d6daf340bd6a25d56
