...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.16.0@sha256:5bf8ae2b6663da902262909875011ed724b67fef7fe4723486a84168106dae0a
