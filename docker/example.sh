...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:2.2.5@sha256:2db5c998e9841b976256c6aae7e3a924c618cdca8541d60538777be46323232d
