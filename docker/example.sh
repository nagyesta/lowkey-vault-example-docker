...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.13.0@sha256:b8f29a51b7861a12355556c353c9dbea512993b6c685dc226324f2d4a83bac3a
