...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.6.4@sha256:d8701816b04181ce79a591621bac83f424bf278fcf98129870adc1e8296c6928
