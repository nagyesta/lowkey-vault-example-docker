...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.1.21@sha256:f5298ed7eb18e6ba87a7daae7b35555aae52b358481c12bd646ee0fd11871ab0
