...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.11.1@sha256:4d8603a54293f6b3feb25e66392cc1ac3f7f254bd93612738309b2b1b847c09b
