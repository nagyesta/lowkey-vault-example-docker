...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.8.27@sha256:d326bcd1ad30eae15f481f8f76df90ff58880948c100f8883d020bd3d899d523
