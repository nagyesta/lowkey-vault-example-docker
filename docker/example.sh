...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.4.34@sha256:2d7b82f009fe1b9bc9b7485f411bb1685db80b697d0ec6086142a6a33fa30bc8
