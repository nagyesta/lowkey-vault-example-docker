...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:7.3.0@sha256:00128e02fe9f1b731b96d9d089e979758fb938f09468179e08b1ee48cd551b41
