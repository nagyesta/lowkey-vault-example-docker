...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.22.0@sha256:c19e464a61cbc2d82337dc5c41584f611819641e143964e225f08d3d01c0b0aa
