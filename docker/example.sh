...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.12.17@sha256:da148c26b021cf11ad9a9d36feaff378fc57a33eb1a854ffd1828f5a056635ba
