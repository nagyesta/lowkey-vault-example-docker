...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:2.0.2@sha256:7f4126cb0803d3d56b70207acf01321c31e6d995b38a33a44d979726179ecd35
