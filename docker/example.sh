...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.2.4@sha256:566f3138c5f746ceaa9f42788236fa1ac245585b510ab8cbc0cb50ac031a3c5c
