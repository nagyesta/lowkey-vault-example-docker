...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.1.32@sha256:940324f942b97acaf3f5ffb36c0dabe13f5f1585a4abc5a1f17718bbba96e1eb
