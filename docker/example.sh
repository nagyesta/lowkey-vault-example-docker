...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.13.1@sha256:3186b68d0f54e3a2653a527a3980db96ed3ffc1fda321b70f75daa1a1f53ef7a
