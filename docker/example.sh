...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lowkey-vault-import:/import/:ro nagyesta/lowkey-vault:1.29.0@sha256:89231e8af7bbf9cab6466662cd6fd389d6b8173a6fa2f33bed38a7d37c504702
