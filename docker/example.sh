...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.2.1@sha256:372c827375dfcc00fd277cae2333ff6da62eacf8822274bea7a0f8187333493c
