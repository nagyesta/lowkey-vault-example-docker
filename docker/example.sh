...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.3.1@sha256:a25a3721de9b6deb157f415ae1f92f6b5c88d70ec9ddfa5866b96003f6be4889
