...
docker run --rm --name assumed-id-docker -d -p 8080:8080 -e ASSUMED_ID_PORT=8080 nagyesta/assumed-identity:1.1.0@sha256:55c629c63b0ee757c22c71d051d66ca98699a622ec07f3229eede451bbe5fbbb
