...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.5.0@sha256:d5c9d340197c9ee52048f46fa3ba3955435883332430bcc19e0e9b7c451197e8
