...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.4.13@sha256:f8c1100ab49a1b51b13792d381fbe8db9f7d2fd25c33176bd9a65f87242ce4b7
