...
docker run --rm --name lowkey-docker -d -p 8443:8443 -e LOWKEY_ARGS -v docker-lv-import:/import/:rw -v docker-lv-config:/config/:ro nagyesta/lowkey-vault:2.9.0@sha256:cb01c7807fbb2e19056ca9651c068b106c1f042dcc4324c2d99bddf4640a9b67
