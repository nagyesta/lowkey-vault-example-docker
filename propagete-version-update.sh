...
sed "s/lowkey-vault:.\+/lowkey-vault:${LOWKEY_VAULT_VERSION}-jammy/" < docker-compose-multiarch/docker-compose.yml.bak > docker-compose-multiarch/docker-compose.yml.tmp
